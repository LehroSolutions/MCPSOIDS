...
A production-minded MCP server reference with an operator control center and governance surfaces. This is the current public documentation route for the shipped source snapshot reviewed on 2026-07-13.
