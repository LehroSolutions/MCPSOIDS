...
export const LehroAiToolSchema = z
  .object({
...
export const LEHRO_CHAT_TOOL_DEFINITION = {
  name: 'ask_lehro_ai',
  description:
    'Connects to Lehro Solutions A.I to ask questions or execute specialized skills (analytics, docs, etc).',
  inputSchema: {
    type: 'object',
    properties: {
      ...
      skill: {
        type: 'string',
        description: "Optional: Name of a specific skill to execute (e.g. 'analytics_query')",
      },
